...
.controller('LoginFormController', ['$scope', 'security', 'localizedMessages', 'userService', 'httpRequestTracker',
        function($scope, security, localizedMessages, userService, httpRequestTracker) {
